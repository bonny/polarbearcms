...
(function($){
  ...
  $._timePicker = function(elm, settings) {
    ...
    //$tpDiv.appendTo('#article-dateUnpublish-window').css({'top':elmOffset.top, 'left':elmOffset.left}).hide();
    $tpDiv.insertAfter($(elm)).css({'top':elmOffset.top, 'left':elmOffset.left}).hide();
