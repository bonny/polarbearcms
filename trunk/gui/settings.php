...
$arrDefaultSettings = array(
	...
	"cache_max_age" => array("fieldType" => "singleline", "description" => "How long a page may stay in the cache, in seconds. No value means default value, which is " . POLARBEAR_CACHE_MAX_AGE . "."),
